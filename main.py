...
def get_args_parser():
    parser = argparse.ArgumentParser('CGMambaNet training and evaluation script for image classification', add_help=False)
    ...
    parser.add_argument('--data_set', default='HAM10000', choices=['CIFAR', 'IMNET', 'ISIC2019', 'HAM10000', 'image_folder'],
    ...
    parser.add_argument('--project', default='cgmambanet', type=str,
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('CGMambaNet training and evaluation script', parents=[get_args_parser()])
